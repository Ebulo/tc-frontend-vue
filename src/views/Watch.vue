              ...
              >
                <div ref="hello">
                  <v-responsive max-height="450">
                    ...
                    <!-- <vimeo-player ref="player" @ready="onReady" /> -->
                  ...
                  <v-row class="justify-space-between">
                        ...
                        <v-list-item three-line>
                          ...
                          >
                            <v-list-item-title
                              ...
                              >{{ "User " + video.user }}</v-list-item-title
                            >
                          </v-list-item-content>
                    ...
                    <v-col class="" offset="1" cols="12" md="10">
                      <p>
                        {{
                          truncate
  ...
  methods: {
    ...
    async getVideo(id) {
      ...
      try {
        ...
        if (video.status == 200 && video.statusText == "OK") {
          this.video = video.data;
          console.log(
            "Video in Watch",
            this.video,
            video,
            this.video.subtitle_file
          );
        }
      } catch (err) {
        this.errored = true;
